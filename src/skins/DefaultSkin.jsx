...
export { CommonSidebar as DefaultSidebar };

export function DefaultDesktopView({
  chat,
  mode,
  setMode,
  thinkingTimes,
      ...
      <section className="empty-state">
        <div className="empty-inner">
          <div className="empty-brand">
            ...
            <span>使用{mode === "fast" ? "快速" : "专家"}模式开始对话</span>
          </div>
...
export function DefaultMobileView({
  chat,
  mode,
  setDrawerOpen,
  thinkingTimes,
      ...
      <div className="composer">
        ...
        <div className="composer-bottom">
          ...
          <div className="composer-actions">
            ...
            {streaming ? (
              <button className="composer-icon send stop" aria-label="停止生成" onClick={onStop}>
                <Square className="action-icon" strokeWidth={1.8} />
              </button>
            ) : canSend ? (
